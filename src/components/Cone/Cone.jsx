...
function Cone(props) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (modelViewer) {
        ...
        modelViewer.cameraOrbit = `${rotationAngle}deg 65deg 0deg`;
  ...
  return (
    <div id="model-container" className="cone__container">
      <model-viewer
        className="cone__object"
        ref={modelViewerRef}
        id="model-viewer"
        src="src/components/Cone/cone.glb"
        ar
